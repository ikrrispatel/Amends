...
export function ApplicationStateCard({ application }: ApplicationStateCardProps) {
  return (
    <article className="template-card rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        ...
        <span
          className={`rounded-full border px-2.5 py-1 text-xs font-semibold ${statusStyles[application.status]}`}
        >
